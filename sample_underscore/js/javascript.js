...
$.fn.ready(function(){
    ...
    tmpltr = {
        ...
        fn: {
            setJs: function(_js) {
                tmpltr.$.js.removeClass("invalid");
                if (typeof _js === "string") {
                    try {
                        _js = eval( _js );
                    } catch (e2) {
                        tmpltr.$.js.addClass("invalid");
                        return false;
                    }
                }
                tmpltr.js = _js || tmpltr.js;
            },
            ...
            useDataStructureStyle: function(settings) {
                ...
                if (!settings.data || !settings.js || !settings.structure || !settings.style) { return false; }
                tmpltr.fn.setJs(settings.js);
                tmpltr.fn.setData(settings.data);
                tmpltr.fn.setStructure(settings.structure);
                tmpltr.fn.setStyle(settings.style);
                tmpltr.editors.js.getSession().setValue(settings.js);
                ...
                tmpltr.throttle.render = tmpltr.throttle.render || setTimeout(function(){
                    ...
                    if ((sWhat === "html") || (sWhat === "all")) {
                        tmpltr.$.output.body.html(
                            Mustache.to_html(tmpltr.structure, tmpltr.data, tmpltr.js)
                        );
            ...
            saveToLocal: function(){
                var obj = {
                    js: tmpltr.editors.js.getSession().getValue(),
            ...
            getDefaults: function(){
                ...
                $.get("defaults/script.js?" + iMilli, function(resp) {
                    def.js = resp;
                    areWeThereYet();
                }, "text");
            ...
            getByPath: function(path){
                ...
                $.get( path + "/data.json?" + iMilli, function(resp) {
                    def.data = resp;
                    areWeThereYet();
                }, "text");
            ...
            exportUri: function(){
                ...
                encodeURIComponent(
                    ...
                    "<body>" + Mustache.to_html(tmpltr.structure, tmpltr.data, tmpltr.js) + "</body> " +
                    ...
                    "<form action='" + document.location.protocol + "//" + document.location.host + document.location.pathname + "' method='get' style='display:none'>" + 
                        "<textarea name='js'>"        + tmpltr.editors.js.getSession().getValue()           + "</textarea> " +
            ...
            getFromUrl: function(){
                ...
                if (!params.js || !params.data || !params.structure || !params.style) { return false; }
            ...
            fileDrop: function (evt) {
                ...
                for (var i = 0, f; f = files[i]; i++) {
                    ...
                    reader.onload = (function (theFile) {
                        return function (e) {
                            // clean this up!
                            if (theFile.name.indexOf(".js") > -1) {
                                tmpltr.editors.js.getSession().setValue(e.target.result);
                                tmpltr.fn.setJs(e.target.result);
                            } else if (theFile.name.indexOf(".json") > -1) {
    ...
    var editors = [
        { name: "js",        id: "preJs",        mode: require("ace/mode/javascript").Mode  },
    ...
    tmpltr.editors.js.getSession().on('change', function() {
        tmpltr.fn.setJs(tmpltr.editors.js.getSession().getValue());
